import{r as u,j as J}from"./router_motion-CiPdkZaX.js";import{S as N,O as K,W as Q,c as Z,P as $,a as X,V as E,M as j}from"./three-iG4XuGaA.js";import"./TopNav-fZRUZuqN.js";import"./react-gH-7aFTg.js";import"./index-BGv9AvvD.js";function ee({initialScale:x=1,enabled:p=!0,minScale:F=.25,maxScale:U=1,adaptIntervalMs:V=1e3,fpsSampleSize:y=30,targetFps:R=30,adaptThreshold:P=.85,adaptStep:b=.85}={}){const l=u.useRef(x),d=u.useRef([]),s=u.useRef(performance.now()),c=u.useRef(p);function C(){return l.current}function h(i){l.current=Math.max(F,Math.min(U,i))}function e(){c.current=!1}function w(){c.current=!0}function g(i){if(!c.current)return null;const a=d.current;a.push(i),a.length>y&&a.shift();const m=performance.now();if(m-s.current<V)return null;if(a.length>=Math.max(4,Math.floor(y/3))){const _=1e3/(a.reduce((T,S)=>T+S,0)/a.length);if(_<P*R)return h(l.current*b),d.current.length=0,s.current=m,l.current;if(_>R*1.05)return h(l.current/b),d.current.length=0,s.current=m,l.current}return null}return u.useEffect(()=>{c.current=p},[p]),{getScale:C,setScale:h,sampleFrame:g,start:w,stop:e}}const ne=`precision mediump float;
