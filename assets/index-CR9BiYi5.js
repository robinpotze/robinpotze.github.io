const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./Home-BeFBFQJI.js","./three-QGPY2NKn.js","./router_motion-2JVGeciU.js","./react-Bzgz95E1.js","./TopNav-2JbvURzl.js","./TopNav-BNm4LWZe.css","./Home-CfRnz3ke.css","./Work-CrpO3cgL.js","./index-CPfdYCLe.js","./index-D8ivQTnF.css","./Work-ra8WPt_B.css","./Info-MTdqXfsR.js","./Contact-9dV7HnYp.js","./Entry-rSfkyAYf.js","./Entry-CXIPLmfc.css"])))=>i.map(i=>d[i]);
import{r,j as l,e as _,O as H,c as q,R as W}from"./router_motion-2JVGeciU.js";import{W as K,S as X,O as Y,M as $,P as J,a as I,C as E,V as b,T as F,L as P,R as Q,_ as x,b as Z}from"./three-QGPY2NKn.js";import"./react-Bzgz95E1.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))u(t);new MutationObserver(t=>{for(const e of t)if(e.type==="childList")for(const p of e.addedNodes)p.tagName==="LINK"&&p.rel==="modulepreload"&&u(p)}).observe(document,{childList:!0,subtree:!0});function s(t){const e={};return t.integrity&&(e.integrity=t.integrity),t.referrerPolicy&&(e.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?e.credentials="include":t.crossOrigin==="anonymous"?e.credentials="omit":e.credentials="same-origin",e}function u(t){if(t.ep)return;t.ep=!0;const e=s(t);fetch(t.href,e)}})();const ee=r.createContext(null);function te({children:n}){const[o,s]=r.useState("dark"),u={theme:o,setTheme:s};return l.jsx(ee.Provider,{value:u,children:n})}const ne=`precision highp float;
varying vec2 vUv;
uniform float uTime;
