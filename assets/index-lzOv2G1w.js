const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./Home-B0AEBvBy.js","./ScrollDown-DPTYyJRG.js","./ScrollDown-CmVSJbFN.css","./Home-CjsWNQSh.css","./Work-_eESxVPP.js","./index-lSLRbE8u.js","./index-Cd74AgC6.css","./Blackwall-Dj6KCE75.css","./Work-ra8WPt_B.css","./Entry-DFZtVbww.js","./Entry-CXIPLmfc.css"])))=>i.map(i=>d[i]);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Wv;function OS(){if(Wv)return St;Wv=1;var a=Symbol.for("react.transitional.element"),e=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),u=Symbol.for("react.consumer"),f=Symbol.for("react.context"),d=Symbol.for("react.forward_ref"),p=Symbol.for("react.suspense"),h=Symbol.for("react.memo"),g=Symbol.for("react.lazy"),v=Symbol.iterator;function _(P){return P===null||typeof P!="object"?null:(P=v&&P[v]||P["@@iterator"],typeof P=="function"?P:null)}var x={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},E=Object.assign,T={};function S(P,$,ye){this.props=P,this.context=$,this.refs=T,this.updater=ye||x}S.prototype.isReactComponent={},S.prototype.setState=function(P,$){if(typeof P!="object"&&typeof P!="function"&&P!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,P,$,"setState")},S.prototype.forceUpdate=function(P){this.updater.enqueueForceUpdate(this,P,"forceUpdate")};function y(){}y.prototype=S.prototype;function L(P,$,ye){this.props=P,this.context=$,this.refs=T,this.updater=ye||x}var N=L.prototype=new y;N.constructor=L,E(N,S.prototype),N.isPureReactComponent=!0;var U=Array.isArray,H={H:null,A:null,T:null,S:null,V:null},w=Object.prototype.hasOwnProperty;function I(P,$,ye,Te,J,ve){return ye=ve.ref,{$$typeof:a,type:P,key:$,ref:ye!==void 0?ye:null,props:ve}}function X(P,$){return I(P.type,$,void 0,void 0,void 0,P.props)}function D(P){return typeof P=="object"&&P!==null&&P.$$typeof===a}function C(P){var $={"=":"=0",":":"=2"};return"$"+P.replace(/[=:]/g,function(ye){return $[ye]})}var V=/\/+/g;function de(P,$){return typeof P=="object"&&P!==null&&P.key!=null?C(""+P.key):$.toString(36)}function te(){}function ce(P){switch(P.status){case"fulfilled":return P.value;case"rejected":throw P.reason;default:switch(typeof P.status=="string"?P.then(te,te):(P.status="pending",P.then(function($){P.status==="pending"&&(P.status="fulfilled",P.value=$)},function($){P.status==="pending"&&(P.status="rejected",P.reason=$)})),P.status){case"fulfilled":return P.value;case"rejected":throw P.reason}}throw P}function me(P,$,ye,Te,J){var ve=typeof P;(ve==="undefined"||ve==="boolean")&&(P=null);var Ae=!1;if(P===null)Ae=!0;else switch(ve){case"bigint":case"string":case"number":Ae=!0;break;case"object":switch(P.$$typeof){case a:case e:Ae=!0;break;case g:return Ae=P._init,me(Ae(P._payload),$,ye,Te,J)}}if(Ae)return J=J(P),Ae=Te===""?"."+de(P,0):Te,U(J)?(ye="",Ae!=null&&(ye=Ae.replace(V,"$&/")+"/"),me(J,$,ye,"",function(_t){return _t})):J!=null&&(D(J)&&(J=X(J,ye+(J.key==null||P&&P.key===J.key?"":(""+J.key).replace(V,"$&/")+"/")+Ae)),$.push(J)),1;Ae=0;var Le=Te===""?".":Te+":";if(U(P))for(var Be=0;Be<P.length;Be++)Te=P[Be],ve=Le+de(Te,Be),Ae+=me(Te,$,ye,ve,J);else if(Be=_(P),typeof Be=="function")for(P=Be.call(P),Be=0;!(Te=P.next()).done;)Te=Te.value,ve=Le+de(Te,Be++),Ae+=me(Te,$,ye,ve,J);else if(ve==="object"){if(typeof P.then=="function")return me(ce(P),$,ye,Te,J);throw $=String(P),Error("Objects are not valid as a React child (found: "+($==="[object Object]"?"object with keys {"+Object.keys(P).join(", ")+"}":$)+"). If you meant to render a collection of children, use an array instead.")}return Ae}function z(P,$,ye){if(P==null)return P;var Te=[],J=0;return me(P,Te,"","",function(ve){return $.call(ye,ve,J++)}),Te}function ee(P){if(P._status===-1){var $=P._result;$=$(),$.then(function(ye){(P._status===0||P._status===-1)&&(P._status=1,P._result=ye)},function(ye){(P._status===0||P._status===-1)&&(P._status=2,P._result=ye)}),P._status===-1&&(P._status=0,P._result=$)}if(P._status===1)return P._result.default;throw P._result}var W=typeof reportError=="function"?reportError:function(P){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var $=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof P=="object"&&P!==null&&typeof P.message=="string"?String(P.message):String(P),error:P});if(!window.dispatchEvent($))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",P);return}console.error(P)};function Ee(){}return St.Children={map:z,forEach:function(P,$,ye){z(P,function(){$.apply(this,arguments)},ye)},count:function(P){var $=0;return z(P,function(){$++}),$},toArray:function(P){return z(P,function($){return $})||[]},only:function(P){if(!D(P))throw Error("React.Children.only expected to receive a single React element child.");return P}},St.Component=S,St.Fragment=i,St.Profiler=l,St.PureComponent=L,St.StrictMode=s,St.Suspense=p,St.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=H,St.__COMPILER_RUNTIME={__proto__:null,c:function(P){return H.H.useMemoCache(P)}},St.cache=function(P){return function(){return P.apply(null,arguments)}},St.cloneElement=function(P,$,ye){if(P==null)throw Error("The argument must be a React element, but you passed "+P+".");var Te=E({},P.props),J=P.key,ve=void 0;if($!=null)for(Ae in $.ref!==void 0&&(ve=void 0),$.key!==void 0&&(J=""+$.key),$)!w.call($,Ae)||Ae==="key"||Ae==="__self"||Ae==="__source"||Ae==="ref"&&$.ref===void 0||(Te[Ae]=$[Ae]);var Ae=arguments.length-2;if(Ae===1)Te.children=ye;else if(1<Ae){for(var Le=Array(Ae),Be=0;Be<Ae;Be++)Le[Be]=arguments[Be+2];Te.children=Le}return I(P.type,J,void 0,void 0,ve,Te)},St.createContext=function(P){return P={$$typeof:f,_currentValue:P,_currentValue2:P,_threadCount:0,Provider:null,Consumer:null},P.Provider=P,P.Consumer={$$typeof:u,_context:P},P},St.createElement=function(P,$,ye){var Te,J={},ve=null;if($!=null)for(Te in $.key!==void 0&&(ve=""+$.key),$)w.call($,Te)&&Te!=="key"&&Te!=="__self"&&Te!=="__source"&&(J[Te]=$[Te]);var Ae=arguments.length-2;if(Ae===1)J.children=ye;else if(1<Ae){for(var Le=Array(Ae),Be=0;Be<Ae;Be++)Le[Be]=arguments[Be+2];J.children=Le}if(P&&P.defaultProps)for(Te in Ae=P.defaultProps,Ae)J[Te]===void 0&&(J[Te]=Ae[Te]);return I(P,ve,void 0,void 0,null,J)},St.createRef=function(){return{current:null}},St.forwardRef=function(P){return{$$typeof:d,render:P}},St.isValidElement=D,St.lazy=function(P){return{$$typeof:g,_payload:{_status:-1,_result:P},_init:ee}},St.memo=function(P,$){return{$$typeof:h,type:P,compare:$===void 0?null:$}},St.startTransition=function(P){var $=H.T,ye={};H.T=ye;try{var Te=P(),J=H.S;J!==null&&J(ye,Te),typeof Te=="object"&&Te!==null&&typeof Te.then=="function"&&Te.then(Ee,W)}catch(ve){W(ve)}finally{H.T=$}},St.unstable_useCacheRefresh=function(){return H.H.useCacheRefresh()},St.use=function(P){return H.H.use(P)},St.useActionState=function(P,$,ye){return H.H.useActionState(P,$,ye)},St.useCallback=function(P,$){return H.H.useCallback(P,$)},St.useContext=function(P){return H.H.useContext(P)},St.useDebugValue=function(){},St.useDeferredValue=function(P,$){return H.H.useDeferredValue(P,$)},St.useEffect=function(P,$,ye){var Te=H.H;if(typeof ye=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return Te.useEffect(P,$)},St.useId=function(){return H.H.useId()},St.useImperativeHandle=function(P,$,ye){return H.H.useImperativeHandle(P,$,ye)},St.useInsertionEffect=function(P,$){return H.H.useInsertionEffect(P,$)},St.useLayoutEffect=function(P,$){return H.H.useLayoutEffect(P,$)},St.useMemo=function(P,$){return H.H.useMemo(P,$)},St.useOptimistic=function(P,$){return H.H.useOptimistic(P,$)},St.useReducer=function(P,$,ye){return H.H.useReducer(P,$,ye)},St.useRef=function(P){return H.H.useRef(P)},St.useState=function(P){return H.H.useState(P)},St.useSyncExternalStore=function(P,$,ye){return H.H.useSyncExternalStore(P,$,ye)},St.useTransition=function(){return H.H.useTransition()},St.version="19.1.1",St}var qv;function Zh(){return qv||(qv=1,vd.exports=OS()),vd.exports}var Q=Zh();const E0=M0(Q);var _d={exports:{}},Io={},yd={exports:{}},xd={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Yv;function zS(){return Yv||(Yv=1,(function(a){function e(z,ee){var W=z.length;z.push(ee);e:for(;0<W;){var Ee=W-1>>>1,P=z[Ee];if(0<l(P,ee))z[Ee]=ee,z[W]=P,W=Ee;else break e}}function i(z){return z.length===0?null:z[0]}function s(z){if(z.length===0)return null;var ee=z[0],W=z.pop();if(W!==ee){z[0]=W;e:for(var Ee=0,P=z.length,$=P>>>1;Ee<$;){var ye=2*(Ee+1)-1,Te=z[ye],J=ye+1,ve=z[J];if(0>l(Te,W))J<P&&0>l(ve,Te)?(z[Ee]=ve,z[J]=W,Ee=J):(z[Ee]=Te,z[ye]=W,Ee=ye);else if(J<P&&0>l(ve,W))z[Ee]=ve,z[J]=W,Ee=J;else break e}}return ee}function l(z,ee){var W=z.sortIndex-ee.sortIndex;return W!==0?W:z.id-ee.id}if(a.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var u=performance;a.unstable_now=function(){return u.now()}}else{var f=Date,d=f.now();a.unstable_now=function(){return f.now()-d}}var p=[],h=[],g=1,v=null,_=3,x=!1,E=!1,T=!1,S=!1,y=typeof setTimeout=="function"?setTimeout:null,L=typeof clearTimeout=="function"?clearTimeout:null,N=typeof setImmediate<"u"?setImmediate:null;function U(z){for(var ee=i(h);ee!==null;){if(ee.callback===null)s(h);else if(ee.startTime<=z)s(h),ee.sortIndex=ee.expirationTime,e(p,ee);else break;ee=i(h)}}function H(z){if(T=!1,U(z),!E)if(i(p)!==null)E=!0,w||(w=!0,de());else{var ee=i(h);ee!==null&&me(H,ee.startTime-z)}}var w=!1,I=-1,X=5,D=-1;function C(){return S?!0:!(a.unstable_now()-D<X)}function V(){if(S=!1,w){var z=a.unstable_now();D=z;var ee=!0;try{e:{E=!1,T&&(T=!1,L(I),I=-1),x=!0;var W=_;try{t:{for(U(z),v=i(p);v!==null&&!(v.expirationTime>z&&C());){var Ee=v.callback;if(typeof Ee=="function"){v.callback=null,_=v.priorityLevel;var P=Ee(v.expirationTime<=z);if(z=a.unstable_now(),typeof P=="function"){v.callback=P,U(z),ee=!0;break t}v===i(p)&&s(p),U(z)}else s(p);v=i(p)}if(v!==null)ee=!0;else{var $=i(h);$!==null&&me(H,$.startTime-z),ee=!1}}break e}finally{v=null,_=W,x=!1}ee=void 0}}finally{ee?de():w=!1}}}var de;if(typeof N=="function")de=function(){N(V)};else if(typeof MessageChannel<"u"){var te=new MessageChannel,ce=te.port2;te.port1.onmessage=V,de=function(){ce.postMessage(null)}}else de=function(){y(V,0)};function me(z,ee){I=y(function(){z(a.unstable_now())},ee)}a.unstable_IdlePriority=5,a.unstable_ImmediatePriority=1,a.unstable_LowPriority=4,a.unstable_NormalPriority=3,a.unstable_Profiling=null,a.unstable_UserBlockingPriority=2,a.unstable_cancelCallback=function(z){z.callback=null},a.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):X=0<z?Math.floor(1e3/z):5},a.unstable_getCurrentPriorityLevel=function(){return _},a.unstable_next=function(z){switch(_){case 1:case 2:case 3:var ee=3;break;default:ee=_}var W=_;_=ee;try{return z()}finally{_=W}},a.unstable_requestPaint=function(){S=!0},a.unstable_runWithPriority=function(z,ee){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var W=_;_=z;try{return ee()}finally{_=W}},a.unstable_scheduleCallback=function(z,ee,W){var Ee=a.unstable_now();switch(typeof W=="object"&&W!==null?(W=W.delay,W=typeof W=="number"&&0<W?Ee+W:Ee):W=Ee,z){case 1:var P=-1;break;case 2:P=250;break;case 5:P=1073741823;break;case 4:P=1e4;break;default:P=5e3}return P=W+P,z={id:g++,callback:ee,priorityLevel:z,startTime:W,expirationTime:P,sortIndex:-1},W>Ee?(z.sortIndex=W,e(h,z),i(p)===null&&z===i(h)&&(T?(L(I),I=-1):T=!0,me(H,W-Ee))):(z.sortIndex=P,e(p,z),E||x||(E=!0,w||(w=!0,de()))),z},a.unstable_shouldYield=C,a.unstable_wrapCallback=function(z){var ee=_;return function(){var W=_;_=ee;try{return z.apply(this,arguments)}finally{_=W}}}})(xd)),xd}var jv;function FS(){return jv||(jv=1,yd.exports=zS()),yd.exports}var Sd={exports:{}},Vn={};/**
 * @license React
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ir,depthTest:!1,depthWrite:!1})}function $_(){return new Yi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:gp(),fragmentShader:`
		...
		`,blending:ir,depthTest:!1,depthWrite:!1})}function e0(){return new Yi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:gp(),fragmentShader:`
